...
janitors_closet = create_room("janitors_closet", "A strange, musty smelling closet. The door locks behind you but there is a key pad.")
...
create_exit(bomb_shelter, 'key_holder', "Open key box.", hidden=True)

key_holder = create_room("key_holder", "An old, locked key box is on the wall.")
...
teachers_lounge["items"].append(broom)
