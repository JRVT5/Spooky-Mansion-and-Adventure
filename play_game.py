...
def play1(rooms):
    ...
    while True:
        ...
        if random.randint(0,3)==1:
            ...
            cat_exit=random.choice(cat_room['exits'])
            cat_place=cat_exit['destination']
...
def play2(rooms):
    ...
    while True:
        ...
        if current_place==janitor_place:
            print("Mr. Smith, the janitor, is here.")
            print("You must fight the janitor to get out of this room, unless you have the broom.")
            if "Broom" in stuff:
                print("You have the broom. You may pass.")
                pass
            else:
                print("To pass you must answer the riddle.")
                choice=input("David’s parents have three sons: Snap, Crackle, and what’s the name of the third son?")
                if choice in ["David", "david"]:
        ...
        if random.randint(0,2)==1:
            janitor_room=rooms[janitor_place]
            janitor_exit=random.choice(janitor_room['exits'])
            janitor_place=janitor_exit['destination']
